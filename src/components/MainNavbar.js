...
export default function MainNavbar() {
  ...
  return (
    <>
      ...
      {/* === Main Navbar === */}
      <Navbar expand="lg" className="smart-navbar bg-white border-bottom py-2">
          ...
          <div className="">
            ...
            <Collapse isOpen={true} navbar className="d-none d-lg-flex">
                        ...
                        <div className="row g-4">
                          {menu.submenu.map((sub, i) => (
                            <div key={i} className="col">
                              ...
                              <ul className="list-unstyled small st-ul-li">
              ...
              <div className="ms-auto right-grid d-flex justify-content-end">
                <Link href="/" className="me-3 d-none d-sm-block text-dark">
                   <div className="d-flex">
                       <FiPhoneCall size={40} className="me-2 mt-1 rounded-circle p-2 st-bg text-white" />
                       <div className="">
                           <p className="small mt-0 mb-0 ">Talk to our experts</p>
                            123 123 123 12
                       </div>
                   </div>
                </Link>
                <UncontrolledDropdown>
                  <DropdownToggle caret color="primary" className="rounded-pill btn-danger w-100  btn btn-danger  px-4 border-0 st-bg">
                    Login
                  </DropdownToggle>
