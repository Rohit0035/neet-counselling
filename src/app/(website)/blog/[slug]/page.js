...
const BlogDetail = () => {
    ...
    const fetchRelatedBlogs = async () => {
        const res = await fetch(`/api/website/blogs/${slug}/related-blogs`);
        const data = await res.json();

        setRelatedBlogs(data);
    };
    const fetchBlogComments = async () => {
        const res = await fetch(`/api/website/blogs/${slug}/comments`);
        const data = await res.json();
    ...
    const fetchBlog = async () => {
        const res = await fetch(`/api/website/blogs/${slug}`);
        const data = await res.json();
                ...
                <Row className="">
                    <Col lg="8" className="mb-3">
                        <div className="position-relative mb-4">
                            <Image
                                src={blog?.image || "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=1200&auto=format&fit=crop"}
                                alt="blog"
                        ...
                        <div className="bg-white rounded-5 shadow-sm p-3">
                            ...
                            <BlogCommentForm comments={comments} slug={slug} fetchBlogComments={fetchBlogComments} />
